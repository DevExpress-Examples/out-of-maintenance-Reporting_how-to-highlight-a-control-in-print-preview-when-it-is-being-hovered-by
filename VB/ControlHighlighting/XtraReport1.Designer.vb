...
'ORIGINAL LINE: this.xrLabel1.Draw += new DevExpress.XtraReports.UI.DrawEventHandler(this.xrLabel1_Draw);
			' 
			' TopMargin
			' 
			...
			' sqlDataSource1
			' 
			Me.sqlDataSource1.ConnectionName = "ControlHighlighting.Properties.Settings.nwindConnectionString"
